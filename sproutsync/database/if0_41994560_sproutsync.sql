...
-- Generation Time: Jun 06, 2026 at 05:18 AM
...
--
-- Database: `if0_41994560_sproutsync`
--
...
INSERT INTO `plants` (`plant_id`, `user_id`, `species_id`, `nickname`, `location`, `planted_date`, `last_watered`, `status`, `created_at`) VALUES
(1, 1, 1, 'Kitchen Desk Basil', 'Kitchen Windowsill', '2026-05-01', '2026-05-22 10:00:00', 'needs_water', '2026-05-22 16:15:00'),
(2, 1, 4, 'Spiky Companion', 'Living Room Balcony', '2026-02-10', '2026-05-18 14:20:00', 'healthy', '2026-05-22 16:20:00');
...
--
ALTER TABLE `scans`
  MODIFY `scan_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
